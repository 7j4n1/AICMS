    ...
    <header class="header">
        <div class="logo-container">
            <a href="{{ $homeUrl }}" class="logo">
                <img src="{{ asset($dashLogoUrl) }}" width="55" height="35" alt="Companion" />
            </a>
            ...
            <div id="userbox" class="userbox">
                <a href="#" data-bs-toggle="dropdown">
                    ...
                    <div class="profile-info" data-lock-name="John Doe"
                        data-lock-email="{{auth('admin')->user()->email}}">
                ...
                <div class="dropdown-menu">
                    <ul class="list-unstyled mb-2">
                        ...
                        <li>
                            <a role="menuitem" tabindex="-1" href="{{route('admins')}}"><i
                        ...
                        @else
                        <li>
                            <a role="menuitem" tabindex="-1" href="{{ route('user.logout') }}"><i
                                    class="bx bx-power-off"></i> Logout</a>
                        </li>
                        @endif
