<div class="container">
                                    ...
                                    <div class="widget-summary">
                                        ...
                                        <div class="widget-summary-col">
                                            <div class="summary">
                                                ...
                                                <div class="info">
                                                    <strong class="amount">&#8358;
                                                        {{number_format($total_total, 2)}}</strong>
                                                </div>
                                            </div>
                                    ...
                                    <div class="widget-summary">
                                        ...
                                        <div class="widget-summary-col">
                                            <div class="summary">
                                                ...
                                                <div class="info">
                                                    <strong class="amount">&#8358;
                                                        {{number_format($total_saving, 2)}}</strong>
                                                </div>
                                            </div>
                                            <div class="summary-footer">
                                    ...
                                    <div class="widget-summary">
                                        ...
                                        <div class="widget-summary-col">
                                            <div class="summary">
                                                ...
                                                <div class="info">
                                                    <strong class="amount">&#8358;
                                                        {{number_format($total_share, 2)}}</strong>
                                                </div>
                                            </div>
                                            <div class="summary-footer">
    ...
    <form wire:submit="searchResult" class="row g-3">
        ...
        <div class="col-md-2 mb-2">
            <div class="form-group">
                ...
                <input type="text" name="coopId" id="coopId" placeholder="Coop Id" class="form-control"
                    wire:model.live="coopId">
            </div>
        </div>
        @endcanany
        <div class="col-md-3 mb-2">
            ...
            <div class="form-group">
                ...
                <input type="date" name="beginning_date" id="beginning_date" class="form-control"
                    wire:model.live="beginning_date">
            </div>
        </div>
        <div class="col-md-3 mb-2">
            <!-- Date Range input type -->
        ...
        <div class="col-md-3 mb-4" style="padding-top: 2%;">
            ...
            @endcanany
            @if (Auth::guard('admin')->check() && Auth::guard('admin')->user()->hasRole('member', 'admin'))
            <a href="{{ route('individualReportDownload', ['id' => $coopId, 'beginning_date' => $beginning_date, 'ending_date' => $ending_date]) }}"
                class="btn btn-primary">Export to Pdf</a>
            @else
            <a href="{{ route('individualReportDownloadAdmin', ['id' => $coopId, 'beginning_date' => $beginning_date, 'ending_date' => $ending_date]) }}"
                class="btn btn-primary">Export to Pdf</a>
            @endif
    ...
    <script src="{{ asset('vendor/datatables/extras/TableTools/Buttons-1.4.2/js/dataTables.buttons.min.js') }}">
    </script>
    <script src="{{ asset('vendor/datatables/extras/TableTools/Buttons-1.4.2/js/buttons.bootstrap4.min.js') }}">
    </script>
    ...
    <script>
        function sendMsg(value) {
            Livewire.dispatch('download-payments', {
                id: value
            });
        }
        ...
        function downloadLedger(value) {
            console.log(value);
            Livewire.dispatch('on-downloadLedger', {
                id: value
            });
        }
    </script>
