...
<div wire:ignore.self id="MemberModal" class="modal fade" tabindex="-1" aria-labelledby="MemberModalLabel"
    aria-hidden="true">
                ...
                <form wire:submit.prevent="saveMember" class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" placeholder="Next of Kin Phone Number"
                            wire:model.live="nextOfKinPhoneNumber" />
                    </div>
...
{{-- Update Modal Form --}}
<div wire:ignore.self id="MemberUpdateModal" class="modal fade" tabindex="-1" aria-labelledby="MemberUpdateModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <form wire:submit.prevent="saveMember" class="row g-3">
                    ...
                    <div class="col-md-12">
                        <label for="title">Assign Coop ID <span class="text-danger">*</span></label>
                        <input type="text" name="coopId" class="form-control" placeholder="Coop ID"
                            wire:model="coopId" />
                        @error('coopId') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        <label for="nextOfKinName" class="form-label">Next of Kin Name </label>
                        <input type="text" class="form-control" placeholder="Next of Kin Name" name="nextOfKinName"
                            wire:model="nextOfKinName" />
                    </div>
                    ...
                    <div class="col-md-6">
                        <label for="nextOfKinPhoneNumber" class="form-label">Next of Kin Phone Number </label>
                        <input type="text" class="form-control" placeholder="Next of Kin Phone Number"
                            name="nextOfKinPhoneNumber" wire:model="nextOfKinPhoneNumber" />
                    </div>
        ...
        Livewire.on('close-modal', () => {
            ...
            (function($) {
                ...
                var datatableInit = function() {
                        ...
                        buttons: [{
                            ...
                            },
                            {
                                ...
                                customize: function(doc) {
                                    ...
                                    $('#datatable-tabletools').find(
                                        'tbody tr:first-child td').each(function() {
                                        if ($(this).attr('colspan')) {
                                            for (var i = 1; i <= $(this).attr(
                                                    'colspan'); $i++) {
                                                colCount.push('*');
                                            }
                                        } else {
                    ...
                    $('<div />').addClass('dt-buttons mb-2 pb-1 text-end').prependTo(
                        '#datatable-tabletools_wrapper');

                    $table.DataTable().buttons().container().prependTo(
                        '#datatable-tabletools_wrapper .dt-buttons');

                    $('#datatable-tabletools_wrapper').find('.btn-secondary').removeClass('btn-secondary')
            ...
            (function($) {
                ...
                var datatableInit2 = function() {
                    ...
                    $('<div />').addClass('dt-buttons mb-2 pb-1 text-end').prependTo(
                        '#datatable-tabletools2_wrapper');

                    table2.DataTable().buttons().container().prependTo(
                        '#datatable-tabletools2_wrapper .dt-buttons');

                    $('#datatable-tabletools2_wrapper').find('.btn-secondary').removeClass('btn-secondary')
                        .addClass('btn-default');
                };
            ...
            <section class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <button class="btn btn-primary"
                                    @click="isOpen = true; @this.set('isModalOpen', true)">Add New <i
                    ...
                    <div x-cloak x-show="isOpen" x-transition:opacity.duration.500ms
                        class="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center" tabindex="-1">
                            ...
                            <div class="">
                                <div class="bg-gray-200 p-3 flex justify-between items-center rounded-t-lg">
                                    <h5 class="modal-title fw-bold" id="MemberModalLabel">
                                        {{ $editingMemberId ? 'Edit Member details' : 'Add new details' }}
                                    </h5>
                                    <button type="button" class="btn-close transition duration-300"
                                        @click="isOpen = false; @this.set('isModalOpen', false)"
                                        aria-label="Close"></button>
                                </div>
                                <div class="p-5">

                                    {{-- Form starts --}}
                                    <form wire:submit="{{ $editingMemberId ? 'updateMember' : 'saveMember' }}"
                                        class="row g-3">

                                        {{-- CoopId --}}
                                        <div class="col-md-12">
                                            <label for="title">Assign Coop ID <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" placeholder="Coop ID"
                                                wire:model="memberForm.coopId"
                                                {{ $editingMemberId ? 'disabled' : '' }} />
                                            @error('memberForm.coopId') <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" placeholder="Surname"
                                                wire:model="memberForm.surname" />
                                            @error('memberForm.surname') <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <label for="otherNames">Other Names </label>
                                            <input type="text" class="form-control" placeholder="Other Names"
                                                wire:model="memberForm.otherNames" />
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" placeholder="Occupation"
                                                wire:model="memberForm.occupation" />
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <label for="phoneNumber" class="form-label">Phone Number </label>
                                            <input type="text" class="form-control" placeholder="Phone Number"
                                                wire:model="memberForm.phoneNumber" />
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <label for="accountNumber" class="form-label">Account Number </label>
                                            <input type="text" class="form-control" placeholder="Account Number"
                                                wire:model="memberForm.accountNumber" />
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" placeholder="Bank Name"
                                                wire:model="memberForm.bankName" />
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <label for="nextOfKinName" class="form-label">Next of Kin Name </label>
                                            <input type="text" class="form-control" placeholder="Next of Kin Name"
                                                wire:model="memberForm.nextOfKinName" />
                                        </div>

                                        {{-- Next of Kin Phone Number --}}
                                        <div class="col-md-6">
                                            <label for="nextOfKinPhoneNumber" class="form-label">Next of Kin Phone
                                                Number </label>
                                            <input type="text" class="form-control"
                                                placeholder="Next of Kin Phone Number"
                                                wire:model="memberForm.nextOfKinPhoneNumber" />
                                        </div>
                                        ...
                                        <div class="text-end">
                                            ...
                                            <button type="submit"
                                                class="btn btn-success transition duration-300">{{ $editingMemberId ? 'Update' : 'Add' }}
                                                Member</button>
                                        </div>
                        ...
                        <tbody>
                            ...
                            <tr wire:key="item-profile-{{ $mem->id }}">
                                ...
                                <td class="">
                                    ...
                                    <button wire:click="editOldMember('{{ $mem->id }}')"
