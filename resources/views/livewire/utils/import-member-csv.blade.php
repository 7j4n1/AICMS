...
<div class="container">
    ...
    <div class="card-body p-4">
        <h2 class="card-title h4 mb-4 text-dark">CSV File Upload & Batch Processing</h2>
...
<script>
    ...
    $wire.on('start-polling', () => {
        pollingInterval = setInterval(() => {
            $wire.dispatch('check-progress');
