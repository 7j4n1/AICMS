            ...
            <section class="card">
                <header class="card-header">
                    @if (Auth::guard('admin')->check() && Auth::guard('admin')->user()->hasRole('member', 'admin'))
                        <h2 class="card-title">My Purchase History</h2>
                    @else
                        <h2 class="card-title">Individual Purchase History</h2>
                    @endif
                </header>
                <div class="card-body">
                    <div class="row mb-3">
                                    ...
                                    <div class="widget-summary">
                                        ...
                                        <div class="widget-summary-col">
                                            <div class="summary">
                                                ...
                                                <div class="info">
                                                    <strong class="amount">{{ ($purchase) ? ($purchase->payment_status == '1' ? 'Active' : 'In Active') : 'Nil' }}</strong>
                                                </div>
                                            </div>
                                            <div class="summary-footer">
            ...
            <section class="card">
                <header class="card-header">
                    @if (Auth::guard('admin')->check() && Auth::guard('admin')->user()->hasRole(['member'], 'admin'))
                        <h2 class="card-title">My Purchase History</h2>
                    @else
                        <h2 class="card-title">All Individual History</h2>
                    @endif
                </header>
                <div class="card-body">
