<x-layout bodyClass="" pageTitle="Homepage">
		<section class="body">
						...
						<div class="col-lg-6">
							<section class="card">
								...
								<div class="card-body">
									...
									<!-- Modal Basic -->
									<a class="mb-1 mt-1 me-1 modal-basic btn btn-default" href="#modalBasic">Basic</a>
									...
									<!-- Modal Icon -->
									<a class="mb-1 mt-1 me-1 modal-basic btn btn-default" href="#modalIcon">Icon</a>
									...
									<!-- Modal Center Icon -->
									<a class="mb-1 mt-1 me-1 modal-basic btn btn-default" href="#modalCenterIcon">Center Icon</a>
										...
										<section class="card">
											<div class="card-body text-center">
												<div class="modal-wrapper">
													...
													<div class="modal-text">
														<h4 class="font-weight-bold text-dark">Are you sure?</h4>
									...
									<!-- Modal No Title -->
									<a class="mb-1 mt-1 me-1 modal-basic btn btn-default" href="#modalNoTitle">No Title</a>
									...
									<!-- Modal No Footer -->
									<a class="mb-1 mt-1 me-1 modal-basic btn btn-default" href="#modalNoFooter">No Footer</a>
									...
									<!-- Modal Center -->
									<a class="mb-1 mt-1 me-1 modal-basic btn btn-default" href="#modalCenter">Center</a>
									...
									<!-- Modal Bootstrap -->
									<a class="mb-1 mt-1 me-1 btn btn-default" data-bs-toggle="modal" data-bs-target="#modalBootstrap" href="#">Bootstrap</a>
							...
							<section class="card">
								...
								<div class="card-body">
									...
									<!-- Modal Primary -->
									<a class="mb-1 mt-1 me-1 modal-basic btn btn-primary" href="#modalPrimary">Primary</a>
									...
									<!-- Modal Success -->
									<a class="mb-1 mt-1 me-1 modal-basic btn btn-success" href="#modalSuccess">Success</a>
									...
									<!-- Modal Info -->
									<a class="mb-1 mt-1 me-1 modal-basic btn btn-info" href="#modalInfo">Info</a>
									...
									<!-- Modal Warning -->
									<a class="mb-1 mt-1 me-1 modal-basic btn btn-warning" href="#modalWarning">Warning</a>
									...
									<!-- Modal Danger -->
									<a class="mb-1 mt-1 me-1 modal-basic btn btn-danger" href="#modalDanger">Danger</a>
							...
							<section class="card">
								...
								<div class="card-body">
									...
									<!-- Modal Info -->
									<a class="mb-1 mt-1 me-1 modal-basic btn btn-info" href="#modalHeaderColorInfo">Info</a>
									...
									<!-- Modal Warning -->
									<a class="mb-1 mt-1 me-1 modal-basic btn btn-warning" href="#modalHeaderColorWarning">Warning</a>
									...
									<!-- Modal Danger -->
									<a class="mb-1 mt-1 me-1 modal-basic btn btn-danger" href="#modalHeaderColorDanger">Danger</a>
							...
							<section class="card">
								...
								<div class="card-body">
									...
									<!-- Modal Primary -->
									<a class="mb-1 mt-1 me-1 modal-basic btn btn-primary" href="#modalFullColorPrimary">Primary</a>
									...
									<!-- Modal Success -->
									<a class="mb-1 mt-1 me-1 modal-basic btn btn-success" href="#modalFullColorSuccess">Success</a>
									...
									<!-- Modal Info -->
									<a class="mb-1 mt-1 me-1 modal-basic btn btn-info" href="#modalFullColorInfo">Info</a>
									...
									<!-- Modal Warning -->
									<a class="mb-1 mt-1 me-1 modal-basic btn btn-warning" href="#modalFullColorWarning">Warning</a>
									...
									<!-- Modal Danger -->
									<a class="mb-1 mt-1 me-1 modal-basic btn btn-danger" href="#modalFullColorDanger">Danger</a>
						...
						<div class="col-lg-6">
							<section class="card">
								...
								<div class="card-body">
									...
									<!-- Modal XS -->
									<a class="mb-1 mt-1 me-1 modal-sizes btn btn-default" href="#modalXS">Extra Small</a>
									...
									<!-- Modal SM -->
									<a class="mb-1 mt-1 me-1 modal-sizes btn btn-default" href="#modalSM">Small</a>
									...
									<!-- Modal MD -->
									<a class="mb-1 mt-1 me-1 modal-sizes btn btn-default" href="#modalMD">Medium</a>
									...
									<!-- Modal LG -->
									<a class="mb-1 mt-1 me-1 modal-sizes btn btn-default" href="#modalLG">Large</a>
									...
									<!-- Modal Full -->
									<a class="mb-1 mt-1 me-1 modal-sizes btn btn-default" href="#modalFull">Full</a>
							...
							<section class="card">
								...
								<div class="card-body">
									<div class="row">
										<div class="col-lg-6">
											<a class="mb-1 mt-1 me-1 modal-with-zoom-anim ws-normal btn btn-default" href="#modalAnim">Open with fade-zoom animation</a>
										</div>
										<div class="col-lg-6">
											<a class="mb-1 mt-1 me-1 modal-with-move-anim ws-normal btn btn-default" href="#modalAnim">Open with fade-slide animation</a>
										</div>
									</div>
