...
<head>
    ...
    <title>Group Report Ledger | Companion</title>
        ...
        <div class="col-md-12 col-sm-12 mb-4 ">
            <div class="panel panel-default" style="margin-top: 2px;">
                <div class="panel-heading">
                    <h3 class="panel-title">Group-Based Account Information (Group {{ $group_from }} - {{ $group_to }})</h3>
                </div>
    ...
    <div class="row row-no-gutters">
        <div class="col-md-12 col-sm-12 mb-4 col-no-gutters">
            <div class="panel" style="margin-top: 5px;">
                ...
                <div class="panel-body">
                    <div class="row row-no-gutters">
                        <div class="col-md-3 col-sm-3 col-xs-3 col-no-gutters">
                            <div class="rounded">
                                <div class="p-2 ">Date printed</div>
                                <div class="panel-title p-2"><span class="text-bold"> {{date('d-M-Y')}}</span></div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-3 mb-2 col-xs-3 col-no-gutters">
                            <div class="rounded">
                        ...
                        <div class="col-md-3 col-sm-3 mb-2 col-xs-3 col-no-gutters">
                            <div class="rounded">
                                <div class="p-2 ">Group Range</div>
                                <div class="panel-title p-2"><span class="text-bold">{{ $group_from }} - {{ $group_to }}</span></div>
                            </div>
                        </div>
